...
public class FancyGroundFactory implements GroundFactory {
	 ...
	 * Constructor.
	 *
	 * Takes a collection of Ground and puts together a lookup table that will allow instantiation of Ground
	 * subclass objects based on lookup of the character that represents them.  This means that GameMaps will
	 * not be able to have different types of terrain that have identical characters representing them, but that
	 * would make the maps look confusing in the UI anyway.
	 *
